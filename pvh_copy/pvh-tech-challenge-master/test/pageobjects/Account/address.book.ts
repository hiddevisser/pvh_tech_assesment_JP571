...
class AddressBook extends Page {
	...
	async inputAndSubmitAddress(firstName: string, lastName: string, street: string, houseNumber: string, city: string, zipcode: string) {
	...
	async verifyAddressAddedAndDelete(street: string) {
